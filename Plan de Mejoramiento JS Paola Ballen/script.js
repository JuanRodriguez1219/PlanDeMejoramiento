...
//Leer el contenido de nuestro HTML al que le dimos click y extrae la info del carro
function leerInfo(curso) {
    //Crear un objeto con el contenido del carro actual
    const infoCurso = {
...
//Elimina los carros de la lista_de_carros
